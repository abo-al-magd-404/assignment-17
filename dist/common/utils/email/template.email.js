                    ...
                    <tr>
                        <td class="hero-section">
                            ...
                            <p style="color: #475569; font-size: 16px; line-height: 1.6; margin: 0;">
                                Hi! To continue with <strong>${config_1.APPLICATION_NAME}</strong>, <br> 
                    ...
                    <tr>
                        <td class="footer">
                            ...
                            <p style="color: #94a3b8; font-size: 11px; margin: 0; letter-spacing: 0.5px; text-transform: uppercase;">
                                &copy; ${new Date().getFullYear()} ${config_1.APPLICATION_NAME}
                            </p>
                        </td>
                    </tr>
                </table>
